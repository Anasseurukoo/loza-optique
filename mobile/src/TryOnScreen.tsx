...
export default function TryOnScreen({ initial, onClose }: { initial: CatalogueItem; onClose: () => void }) {
  ...
  return <View style={styles.root}>
    ...
    {overlay ? <Image source={active.image} style={[styles.glasses, {
...
const styles = StyleSheet.create({
  ...
  glasses: { position: 'absolute', resizeMode: 'contain', zIndex: 4 },
  ...
  subLogo: { color: '#D8BF82', fontSize: 6, fontWeight: '800', letterSpacing: 2, textAlign: 'center', marginTop: 4 },
  ...
  liveDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#73D7A7' }, liveText: { color: '#fff', fontSize: 7, fontWeight: '900', letterSpacing: 1 },
  hint: { position: 'absolute', top: '63%', left: 0, right: 0, alignItems: 'center' },
  hintText: { color: '#fff', fontSize: 10, fontWeight: '700', backgroundColor: 'rgba(7,19,21,.6)', paddingHorizontal: 15, paddingVertical: 9, borderRadius: 18 },
  ...
  activeLabel: { color: '#D8BF82', fontSize: 7, fontWeight: '900', letterSpacing: 2, textAlign: 'center' },
  ...
  privacy: { alignItems: 'center' }, privacyText: { color: '#8EA2A2', fontSize: 7, letterSpacing: .5 },
  permission: { flex: 1, backgroundColor: '#071315', alignItems: 'center', justifyContent: 'center', padding: 30 }, permissionIcon: { width: 82, height: 82, borderRadius: 41, backgroundColor: '#17474B', alignItems: 'center', justifyContent: 'center' }, permissionIconText: { color: '#D8BF82', fontSize: 38 }, permissionKicker: { color: '#D8BF82', fontSize: 8, fontWeight: '900', letterSpacing: 2, marginTop: 26 }, permissionTitle: { color: '#F3EEDF', fontSize: 31, fontWeight: '600', marginTop: 9 }, permissionCopy: { color: '#9FB1AF', fontSize: 12, lineHeight: 19, textAlign: 'center', marginTop: 13, maxWidth: 315 }, permissionButton: { height: 54, borderRadius: 27, backgroundColor: '#D8BF82', paddingHorizontal: 28, alignItems: 'center', justifyContent: 'center', marginTop: 27 }, permissionButtonText: { color: '#071315', fontSize: 9, fontWeight: '900', letterSpacing: 1.2 }, cancel: { color: '#9FB1AF', fontSize: 11, marginTop: 20 },
